class LookAtEntity{
  ...
  LookAtEntity(this.longitude, this.latitude, this.zoom, this.tilt, this.heading);
   ...
   String lookAt() => '''
      ...
      ''';
   String linearLookAt() =>
      '<LookAt><longitude>$longitude</longitude><latitude>$latitude</latitude><range>$zoom</range><tilt>$tilt</tilt><heading>$heading</heading><gx:altitudeMode>relativeToGround</gx:altitudeMode></LookAt>';
